...
//determine what each value means and how its markov chain works
function msg_int(a) {
    value = a;
    switch(value) {
        //previous value: slow down
        case 0:
            outletVal = mkChain(10, 50, 65, 80, 90, 101);
            outlet(outletVal, 0);
            outlet(6, outletVal);
            break;
        //previous value: speed up
        case 1:
            outletVal = mkChain(40, 50, 65, 80, 90, 101);
            outlet(outletVal, 0);
            outlet(6, outletVal);
            break;
        //previous value: becoming detached
        case 2:
            outletVal = mkChain(10, 20, 30, 70, 85, 101);
            outlet(outletVal, 0);
            outlet(6, outletVal);
            break;
        //previous value: becoming connected
        case 3:
            outletVal = mkChain(10, 20, 60, 70, 85, 101);
            outlet(outletVal, 0);
            outlet(6, outletVal);
            break;
        //previous value: becoming sul pont
        case 4:
            outletVal = mkChain(15, 30, 40, 50, 60, 101);
            outlet(outletVal, 0);
            outlet(6, outletVal);
            break;
        //previous value: becoming sul tast
        case 5:
